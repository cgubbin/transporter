...
pub(crate) fn fermi_integral_m05<T: Copy + RealField>(u: T) -> T {
    if u <= -2. {
        ...
        ex * (1.77245385090551603e0
            - ex * (40641.4537510284430e0
                + t * (9395.7080940846442e0
                    + t * (649.96168315267301e0
                        + t * (12.7972295804758967e0 + t * 0.00153864350767585460e0))))
                / (32427.1884765292940e0
                    + t * (11079.9205661274782e0
                        + t * (1322.96627001478859e0 + t * (63.738361029333467e0 + t)))))
    } else if u <= 0. {
        let s = -0.5 * u;
        let t = 1. - s;
        (272.770092131932696e0
